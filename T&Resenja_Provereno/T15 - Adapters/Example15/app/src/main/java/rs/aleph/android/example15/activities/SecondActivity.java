...
public class SecondActivity extends AppCompatActivity {
    ...
    // Position of the item to be displayed in the detail activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            this.position = savedInstanceState.getInt(POSITION_TAG);
        }

        // Loads an URL into the WebView
        position = getIntent().getIntExtra(POSITION_TAG, 0);
    ...
    public void onSaveInstanceState(Bundle savedInstanceState) {
        ...
        savedInstanceState.putInt(POSITION_TAG, position);
    }
}
